...
public class ECHKPSPublicSoap
{
    ...
    public ECHKPSPublicSoap(){}

    public ECHKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public ECHKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        ECHExtendedSoapSerializationEnvelope envelope= new ECHExtendedSoapSerializationEnvelope(ECHExtendedSoapSerializationEnvelope.VER11);
