...
public class ECHExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(ECHDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new ECHStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static ECHDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static ECHDateTimeConverter dateTimeConverter = new ECHStandardDateTimeConverter();

    public ECHExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public ECHExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new ECHMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=ECHHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,ECHExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=ECHHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
